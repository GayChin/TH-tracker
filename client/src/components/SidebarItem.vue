...
const selectedSidebarItemStyle = 'text-[#fcb220] bg-[#f5f6fb] font-bold'
...
<template>
    <router-link class="relative text-xl flex flex-row gap-4 items-center w-[80%] justify-center py-3 rounded-l-[40px]"
        ...
        <div :class="pathIsMatched ? 'absolute bg-[#343951] h-6 w-full -bottom-6 right-0 rounded-tr-[100px]' : 'hidden'"></div>
    </router-link>
</template>
